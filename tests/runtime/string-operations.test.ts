  ...
  describe('String Manipulation Functions', () => {
    it('should implement nami_string_concat for concatenation', () => {
      expect(runtimeHeader).toContain(
        'nami_string_t* nami_string_concat(nami_string_t* a, nami_string_t* b)'
      );
    ...
    it('should implement nami_string_substring for extraction', () => {
      expect(runtimeHeader).toContain(
        'nami_string_t* nami_string_substring(nami_string_t* str, int64_t start, int64_t end)'
      );
    ...
    it('should implement nami_string_split for splitting by delimiter', () => {
      expect(runtimeHeader).toContain(
        'nami_array_t* nami_string_split(nami_string_t* str, nami_string_t* delimiter)'
      );
    ...
    it('should implement nami_string_join for joining array with separator', () => {
      expect(runtimeHeader).toContain(
        'nami_string_t* nami_string_join(nami_array_t* arr, nami_string_t* separator)'
      );
    ...
    it('should implement nami_string_index_of for searching', () => {
      expect(runtimeHeader).toContain(
        'int64_t nami_string_index_of(nami_string_t* str, nami_string_t* search)'
      );
    ...
    it('should implement nami_string_replace for replacement', () => {
      expect(runtimeHeader).toContain(
        'nami_string_t* nami_string_replace(nami_string_t* str, nami_string_t* search, nami_string_t* replacement)'
      );
